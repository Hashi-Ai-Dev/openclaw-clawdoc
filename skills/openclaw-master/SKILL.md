...
description: "OpenClaw configuration expert and system doctor. Use for unclassified config questions that don't map to a more specific skill — for specific areas use their dedicated skills (see skill map below). Triggers on: openclaw expert, config doctor, system health, gateway diagnostics, openclaw master, openclaw overview, openclaw help."
---
